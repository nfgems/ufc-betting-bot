...
| `POLYMARKET_CLOB_*_TIMEOUT_SECONDS` | Explicit CLOB connect/read/write/pool phase timeouts | Optional; defaults to `3`/`10`/`5`/`2` seconds. Balance and open-orders safety reads temporarily apply these values under the shared transport lock |
