...
| `POLYMARKET_CLOB_*_TIMEOUT_SECONDS` | Explicit CLOB connect/read/write/pool phase timeouts | Optional; defaults to `3`/`10`/`5`/`2` seconds. The open-orders safety read temporarily applies these values under the shared transport lock |
